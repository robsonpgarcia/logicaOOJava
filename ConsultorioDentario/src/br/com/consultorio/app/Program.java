...
public class Program {
	...
	public static void main(String[] args) {
		...
		Paciente paciente = new Paciente("Roberto", "da Silva", 123, 34, "M", "11 9 9877-2211", "R. Augustino Cobra");
		//Pessoa dentista = new Dentista("Dr. Dente", "da Silva", "Cirurgiao", 123123, true);
		Dentista dentista = new Dentista("Dr. Dente", "da Silva", "Cirurgiao", 123123, true);
		...
		System.out.println(dentista.isDisponivel()==true?"Esta disponivel":"Nao esta disponivel");
		if(dentista.isDisponivel()) {
			dentista.atender();
		} else {
			dentista.remarcar("13/10/2019", "11:00");
		}

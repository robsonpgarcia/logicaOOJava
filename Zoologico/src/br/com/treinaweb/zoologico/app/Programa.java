...
public class Programa {
	...
	public static void main(String[] args) {
		...
		System.out.println("Ola, seu animal é: " + animal1.getEspecie() +
				", o nome do animal é: " + animal1.getNome() +
		...
		if(animal1.ehAdulto()){
			...
			System.out.println("Animal nao é adulto");
		}
		
		
		Gato animal2 = new Gato("Ze", 1);
		
		System.out.println("Ola, seu animal é: " + animal2.getEspecie() +
				", o nome do animal é: " + animal2.getNome() +
